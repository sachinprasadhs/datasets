...
set of the original ImageNet ILSVRC 2012dataset.
"""
...
TRAIN_SUBSET = ('https://drive.google.com/uc?export=download&'
                'id=1Sl1cwy6Dei1I1BMS1YKjI35fkaR1UA_7')

VAL_SUBSET = ('https://drive.google.com/uc?export=download&'
              'id=1AjYczW4khrQrwPIygXUkHF-Qv4QGEsCF')


class ImagenetLt(Imagenet2012):
